              ...
              child: ListTile(
                leading: GestureDetector(
                  child: Container(
                    ...
                    child: const Center(child: Icon(FontAwesomeIcons.play)),
                  ),
                  onTap: () async {
                    String audioasset = ddlist[index].Audiopath;
                ...
                title: Text(ddlist[index].Title.toString()),
                subtitle: Text(ddlist[index].Dua.toString()),
                trailing: GestureDetector(
                  child: Container(
                    ...
                    child: const Center(child: Icon(FontAwesomeIcons.stop)),
                  ),
                  onTap: () async {
